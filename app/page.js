    ...
    <>
      <div className="flex flex-row gap-4 min-h-[90vh] p-6 bg-gray-100">
        <textarea
          ...
          id="edit"
          value={Markdown}
          onChange={e => setMarkdown(e.target.value)} placeholder='write something...'></textarea>

        <div className="w-full md:w-1/2 h-[90vh] p-4 bg-white text-black rounded-md" id="output"></div>
      </div>
